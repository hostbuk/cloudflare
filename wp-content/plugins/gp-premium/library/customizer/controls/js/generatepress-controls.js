( function( $, api ) {
	...
	*/
	api( 'generate_menu_plus_settings[navigation_as_header]', function( value ) {
		...
		api.control( 'generate_settings[nav_layout_setting]', showNavHeaderCallback );
		api.control( 'generate_settings[nav_inner_width]', showNavHeaderCallback );
		api.control( 'generate_settings[nav_alignment_setting]', showNavHeaderCallback );
	} );
